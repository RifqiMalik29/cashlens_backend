...
func TestUserRepository_GetExpiredTrialUsers(t *testing.T) {
	...
	userWithExpiredTrial := &models.User{
		...
		PasswordHash:           "hash1",
		Name:                   models.StringPtr("Expired Trial User"),
		Language:               "en",
		ExpoPushToken:          models.StringPtr(""),
		SubscriptionTier:       "free",
		SubscriptionExpiry:     nil,
		IsFounder:              false,
		IsConfirmed:            true,
		ConfirmationToken:      models.StringPtr(""),
		ConfirmationExpiresAt:  nil,
		DeviceID:               models.StringPtr(""),
	...
	userWithFutureTrial := &models.User{
		...
		PasswordHash:           "hash2",
		Name:                   models.StringPtr("Future Trial User"),
		Language:               "en",
		ExpoPushToken:          models.StringPtr(""),
		SubscriptionTier:       "free",
		SubscriptionExpiry:     nil,
